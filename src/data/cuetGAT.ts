...
export const cuetGatSubject: Subject = {
  id: 'gat',
  ...
  tests: [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          options: ['Colorado River', 'Mississippi River', 'Rio Grande', 'Hudson River'],
          correctAnswer: 0
        },
        {
          id: 'cuet-gk-q15',
        ...
        },
        {
          ...
          options: ['Gobi Desert', 'Arabian Desert', 'Sahara Desert', 'Thar Desert'],
          correctAnswer: 0
        },
        {
          id: 'cuet-gk-q19',
